...
jump = loadSound("assets/point.mp3")
}
...
function Barra(){
  if(frameCount%60===0){
    var barra = createSprite(1200,200,10,900)
    barra.velocityX = -10
    barra.visible = false
...
function Refri(){
  if(frameCount%250===0){
    bonus = createSprite(100, height/2-200)
    bonus.addImage(spriteImg)
    bonus.scale = 0.1
